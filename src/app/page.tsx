...
const Window = ({
  ...
  if (isClosed && closedMessage && onRestore) {
    return (
        <div className={`flex flex-col items-center justify-center p-6 bg-[#0a0a0a] border border-zinc-800 hover:border-[#FFE55C]/50 transition-colors shadow-2xl text-center min-h-[150px] ${className}`}>
          <p className="text-zinc-400 mb-4 font-mono text-sm">{closedMessage}</p>
          <button
              onClick={onRestore}
              className="px-3 py-1.5 bg-zinc-900 text-zinc-400 border-zinc-800 hover:border-[#FFE55C] hover:text-[#FFE55C] border transition-all cursor-pointer text-xs font-mono uppercase"
          >
  ...
  return (
      <div className={`flex flex-col bg-[#0a0a0a] border border-zinc-800 shadow-2xl hover:border-[#FFE55C]/50 transition-colors duration-300 relative ${className}`}>
        ...
        <span>
          ...
          {onClose && (
              <button
                  onClick={onClose}
                  className="text-[#FFE55C] hover:bg-[#FFE55C]/20 px-2 py-0.5 rounded-sm cursor-pointer transition-colors"
              >
                x
              </button>
          )}
...
export default function Home() {
  ...
  // State für jedes einzelne Fenster
  ...
  return (
      <div className="relative min-h-screen bg-[#050505] text-zinc-300 p-4 sm:p-8 lg:p-12 xl:p-16 flex flex-col items-center selection:bg-yellow-400/70 selection:text-black overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start relative">
            ...
            <div className="lg:col-span-6 flex flex-col gap-6 relative">
              ...
              >
                ...
                <Image
                    className="absolute -top-8 -right-1 w-23 h-23 sm:-top-12 sm:-right-5 sm:w-[90px] sm:h-[90px] text-white pointer-events-none z-20 rotate-12"
                ...
                {/* Angepasste Schriftgröße mit Pride-Farben */}
                ...
                <div className="flex flex-col sm:flex-row gap-6 items-start w-full">
                  ...
                  <div className="flex flex-col gap-4 w-full">
                    <div>
                      ...
                      <p className="text-zinc-400">founder of <a href="https://dezentrale-erkelenz.de" target="_blank" rel="noopener noreferrer" className="underline text-[15px] md:text-base hover:text-[#FFE55C] transition-colors">Dezentrale Erkelenz</a></p>
              ...
              >
                <div className="flex flex-col gap-2 font-mono text-sm sm:text-base relative pb-8 sm:pb-0">
                  <a href="https://github.com/sandrpp" className="hover:text-[#FFE55C] transition-colors w-max z-10">
                    <span className="text-zinc-500 mr-4">[gh]</span> github.com/sandrpp
                  </a>
                  <a href="#" className="hover:text-[#FFE55C] transition-colors w-max z-10">
                    <span className="text-zinc-500 mr-4">[dc]</span> @sandrp
                  </a>
                  <a href="mailto:me@sandrp.de" className="hover:text-[#FFE55C] transition-colors w-max z-10">
                    <span className="text-zinc-500 mr-4">[mail]</span> me@sandrp.de
                  </a>
                  <a href="https://matrix.to/#/@me:sandrp.de" className="hover:text-[#FFE55C] transition-colors w-max z-10">
              ...
              >
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                  ...
                  <a
                      href="/pgp.asc"
                      download
                      className="mt-4 sm:mt-0 flex shrink-0 items-center gap-2 text-xs font-bold bg-zinc-900 text-zinc-400 border border-zinc-800 px-3 py-1.5 hover:border-[#FFE55C] hover:text-[#FFE55C] transition-all"
                  >
                    DOWNLOAD PGP
